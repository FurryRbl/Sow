...
public class Dagger_Stone implements ToolMaterial {
    public static final Axe_Stubby INSTANCE = new Axe_Stubby();
    public static final ToolItem DOGGER_STONE = new SwordItem(INSTANCE, 2, 1.0F, new Item.Settings().group(SOW_GROUP)); // 定义一个新的斧
